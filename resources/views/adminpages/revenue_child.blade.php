...
.custom-modal.accountedit {
  ...
  <body>
    ...
    <div style="display:none" class="custom-modal revenueedit" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 style="font-weight: bolder" class="modal-title">Edit revenue</h2>
                    <button type="button" class="close closeModal" style="background: transparent; border: none; font-size: 2.5rem; color: #333;">
                        &times;
                    </button>
                </div>
    
                <form id="revenueeditform">
                    <input type="hidden" id="revenueforminput_edit" value=""/>
                    <div class="row mt-5">
                    ...
                    <div class="modal-footer mt-5" style="justify-content: flex-end; display: flex;">
                        <button id="revenueeditForm" type="submit" class="btn btn-primary" style="margin-right: 10px;">Submit</button>
