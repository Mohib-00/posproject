...
.custom-modal.accountedit {
  ...
  <body>
    ...
    <div style="display:none" class="custom-modal expenseedit" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 style="font-weight: bolder" class="modal-title">Edit expense</h2>
                ...
                <form id="expenseeditform">
                    <input type="hidden" id="expenseforminput_edit" value=""/>
                    <div class="row mt-5">
                    ...
                    <div class="modal-footer mt-5" style="justify-content: flex-end; display: flex;">
                        <button id="expenseeditForm" type="submit" class="btn btn-primary" style="margin-right: 10px;">Submit</button>
